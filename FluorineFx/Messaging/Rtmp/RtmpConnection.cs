...
namespace FluorineFx.Messaging.Rtmp
{
    ...
    public abstract class RtmpConnection : BaseConnection, IServiceCapableConnection, IStreamCapableConnection
	{
        ...
        /// <summary>
        /// A pending receive ServiceCall
        /// </summary>
        protected IServiceCall _pendingReceive;
        /// <summary>
        ...
        /// <summary>
        /// Retrieve pending receive.
        /// </summary>
        /// <param name="invokeId">Pending call service id.</param>
        /// <returns>Pending call service object.</returns>
        public IPendingServiceCall RetrievePendingReceive()
        {
            return _pendingReceive as IPendingServiceCall;
        }
        /// <summary>
