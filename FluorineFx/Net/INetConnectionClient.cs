...
namespace FluorineFx.Net
{
    ...
    interface INetConnectionClient
    {
        ...
        bool Connected { get; }
		Proxy Proxy { get; set; }
        void Command<T>(string endpoint, string destination, string operation, string subtopic, Responder<T> callback, params object[] arguments);
        ...
        void Receive<T>(Responder<T> responder);
